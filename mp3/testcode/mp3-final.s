...
_start:
    ...
    sw x1, aacus, x15 # store x1 to aacus w offset 0 (x15)
...
HOWHIGH:
    ...
    sw x4, MUDPIE, x15 # pc = 3d4 - source of dmem_write error

    la x5, MUDDLER
    nop
    nop
    nop
    jalr x7, x5, 0 # GOT HERE 3
    ...
    nop
    nop
    la x17, COOKIE # GOT HERE 4
    lb x6, 1(x17)
    nop

    lb x7, COOKIE
    nop
    sw x6, crumb, x15 # GOT HERE 5
    nop
    sw x7, crumb, x15
    nop
    nop
...
Beg1:
    ...
    add x1, x2, x3 # GOT HERE 13
    addi x4, x1, 3

    slli x2, x2, 3 # GOT HERE 14
    not x5, x3
    andi x3, x2, 15
    ...
    lw x3, tailspin # GOT HERE 17 (~3950 ns)
    srl x4, x4, 1
    addi x5, x3, 7

    lw x1, quark # GOT HERE 18
    addi x5, x5, 12
    addi x1, x4, 12
    addi x2, x3, 12
